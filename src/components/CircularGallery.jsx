...
const DEFAULT_FONT = "600 26px General Sans, Inter, sans-serif";
...
async function resolveFont(font, fontUrl) {
  ...
  if (!effectiveUrl) {
    if (document.fonts && document.fonts.load) {
      try {
        await document.fonts.load("600 26px General Sans");
...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.x = (this.viewport.width * (990 * this.scale)) / this.screen.width;
